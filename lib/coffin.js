(function() {
  var CloudFormationTemplateContext, fs,
  ...
  CloudFormationTemplateContext = (function() {
    ...
    CloudFormationTemplateContext.prototype._resourceByType = function(type, name, props) {
      var result;
      result = {};
      if (((props != null ? props.Metadata : void 0) != null) || ((props != null ? props.Properties : void 0) != null)) {
        result[name] = props;
        result.Type = type;
      } else {
        result[name] = {
    ...
    CloudFormationTemplateContext.prototype.Mapping = function(name, map) {
      var result;
      if (this._mappings == null) this._mappings = {};
      result = {};
      result[name] = map;
    ...
    CloudFormationTemplateContext.prototype.InitScript = function(arg) {
      ...
      return {
        UserData: this.Base64(this.Join('', data))
      };
    };
