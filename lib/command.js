(function() {
  var CoffeeScript, buildCfnPath, checkChar, coffinChar, colors, commander, compileCommand, compileTemplate, crossChar, exec, fs, generateOutputFileName, generateTempFileName, path, pretty, printCommand, showHelp, spawn, stackCommand, updateOrCreateStack, validateArgs, validateCommand, validateTemplate, writeJsonTemplate, _ref;
  var _this = this;
